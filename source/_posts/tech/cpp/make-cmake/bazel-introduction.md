...
{% include_code lang:bazel bazel-introduction-01.BUILD %}

### 简单源码示例

{% include_code lang:cpp bazel-introduction-02.h %}

{% include_code lang:cpp bazel-introduction-03.cpp %}

{% include_code lang:cpp bazel-introduction-04.cpp %}

{% include_code lang:cpp bazel-introduction-05.cpp %}
