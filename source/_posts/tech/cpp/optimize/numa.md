...
{% include_code affinity_test.c tech/cpp/optimize/numa-01.c %}
...
{% include_code affinity_test_threads_view_cpu0.txt tech/cpp/optimize/numa-02.txt %}

**CPU View示例输出：**

{% include_code affinity_test_cpu_view_cpu0.txt tech/cpp/optimize/numa-03.txt %}
...
{% include_code affinity_test_threads_view_cpu01.txt tech/cpp/optimize/numa-04.txt %}

**CPU View示例输出：**

{% include_code affinity_test_cpu_view_cpu01.txt tech/cpp/optimize/numa-05.txt %}
...
{% include_code sched_setaffinity.c tech/cpp/optimize/numa-06.c %}

**多线程示例：**

{% include_code sched_setaffinity_threads.c tech/cpp/optimize/numa-07.c %}
...
{% include_code numa_basic.c tech/cpp/optimize/numa-08.c %}
...
{% include_code numa_python.py tech/cpp/optimize/numa-09.py %}
...
{% include_code numa_threads_different_nodes.c tech/cpp/optimize/numa-10.c %}
...
{% include_code numa_threads_same_node.c tech/cpp/optimize/numa-11.c %}
