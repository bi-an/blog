...
{% include_code tech/concurrent/atomic-variables-01.cpp %}
...
{% include_code tech/concurrent/atomic-variables-02.cpp %}
...
{% include_code tech/concurrent/atomic-variables-03.cpp %}
...
写回数据：如果一个缓存行处于Modified状态，当该缓行被替换时，数据会被写回主内存，缓存行变为Invalid状态。
...
{% include_code tech/concurrent/atomic-variables-04.cpp %}
...
{% include_code tech/concurrent/atomic-variables-05.cpp %}

fetch_add 示例：

{% include_code tech/concurrent/atomic-variables-06.cpp %}
...
{% include_code tech/concurrent/atomic-variables-07.cpp %}
...
{% include_code tech/concurrent/atomic-variables-08.cpp %}
...
{% include_code tech/concurrent/atomic-variables-09.cpp %}
...
{% include_code tech/concurrent/atomic-variables-10.java %}
...
{% include_code tech/concurrent/atomic-variables-11.cpp %}
...
{% include_code tech/concurrent/atomic-variables-12.cpp %}
...
{% include_code tech/concurrent/atomic-variables-13.cpp %}
...
{% include_code tech/concurrent/atomic-variables-14.cpp %}
