...
{% include_code affinity_test.c tech/memory/numa-01.c %}
...
{% include_code affinity_test_threads_view_cpu0.txt tech/memory/numa-02.txt %}

**CPU View示例输出：**

{% include_code affinity_test_cpu_view_cpu0.txt tech/memory/numa-03.txt %}
...
{% include_code affinity_test_threads_view_cpu01.txt tech/memory/numa-04.txt %}

**CPU View示例输出：**

{% include_code affinity_test_cpu_view_cpu01.txt tech/memory/numa-05.txt %}
...
{% include_code sched_setaffinity.c tech/memory/numa-06.c %}

**多线程示例：**

{% include_code sched_setaffinity_threads.c tech/memory/numa-07.c %}
...
{% include_code numa_basic.c tech/memory/numa-08.c %}
...
{% include_code numa_python.py tech/memory/numa-09.py %}
...
{% include_code numa_threads_different_nodes.c tech/memory/numa-10.c %}
...
{% include_code numa_threads_same_node.c tech/memory/numa-11.c %}
