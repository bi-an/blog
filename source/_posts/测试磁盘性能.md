...
------------------------------------------------------------
read     | 1        | 942        | 58.9       | 1.06
read     | 2        | 1464       | 91.5       | 1.36
read     | 4        | 1652       | 103        | 2.42
read     | 8        | 1733       | 108        | 4.61
read     | 16       | 1782       | 111        | 8.97
```

```
RW       | Threads  | IOPS       | BW(MiB/s)  | AvgLat(ms)
------------------------------------------------------------
write    | 1        | 794        | 49.6       | 1.26
write    | 2        | 1167       | 73.0       | 1.71
write    | 4        | 1418       | 88.6       | 2.82
write    | 8        | 1760       | 110        | 4.54
write    | 16       | 1787       | 112        | 8.93
```

当线程数增加，反而会提高 IO 性能。可能原因是 64KiB 小块数据大量提交到 I/O 队列，操作系统能更好地完成读写路径优化。
